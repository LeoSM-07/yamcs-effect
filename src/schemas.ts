...
export const Processor = Schema.String;
export const Instance = Schema.String;
...
export const IssueCommandRequest = Schema.Struct({
  ...
  /**
   * The sequence number as specified by the origin. This value is communicated
   * back in command history and command queue entries, allowing clients to map
...
export const TmPacketData = Schema.Struct({
  packet: Schema.Uint8ArrayFromBase64,
  sequenceNumber: Schema.Number,
  id: NamedObjectId,
  generationTime: Schema.DateFromString, // RFC 3339 timestamp
  earthReceptionTime: Schema.optional(Schema.DateFromString),
  receptionTime: Schema.DateFromString, // RFC 3339 timestamp
  link: Schema.String,
